   ...
   )
{
    ...
    */
    ...
    dx[1] = x[4];
    dx[2] = x[5];
    dx[3] = ((Iyy[0]- Izz[0])/Ixx[0])*x[4]*x[5]+ u[0]/Ixx[0]- Krx[0]*(x[3]/Ixx[0])- Brx[0]*(x[0]/Ixx[0]);
    dx[4] = ((Izz[0]-Ixx[0])/Iyy[0])*x[3]*x[5]+ u[1]/Iyy[0]- Kry[0]*x[4]/Iyy[0]- Bry[0]*x[1]/Iyy[0];
    dx[5] = ((Ixx[0]-Iyy[0])/Izz[0])*x[3]*x[4]+u[2]/Izz[0]-Krz[0]*x[5]/Izz[0];
}
